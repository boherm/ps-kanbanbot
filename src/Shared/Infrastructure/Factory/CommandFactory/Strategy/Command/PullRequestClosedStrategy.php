...
class PullRequestClosedStrategy implements CommandStrategyInterface
{
    public function __construct(
        private readonly string $pullRequestDashboardNumber,
        private readonly string $closedColumnName,
    ) {
    }
    ...
    {
        return 'pull_request' === $eventType and 'closed' === $payload['action'] and false === $payload['pull_request']['merged'];
    }
